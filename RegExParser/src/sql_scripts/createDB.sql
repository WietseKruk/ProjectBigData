use imdbdb;
CREATE TABLE IF NOT EXISTS MOVIES(movie_title VARCHAR(255) NOT NULL,director VARCHAR(255) NOT NULL,location VARCHAR(255),running_time DOUBLE,genre VARCHAR(255),PRIMARY KEY (movie_title));
